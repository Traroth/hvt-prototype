...
class vulkan_h_6 extends vulkan_h_7 {
    ...
    private static final int VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_HEAP_TENSOR_PROPERTIES_ARM = (int)1000135014L;
    /**
     * {@snippet lang=c :
    ...
    private static final int VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXTURE_COMPRESSION_ASTC_3D_FEATURES_EXT = (int)1000288000L;
    /**
     * {@snippet lang=c :
    ...
    private static final int VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INTERNALLY_SYNCHRONIZED_QUEUES_FEATURES_KHR = (int)1000504000L;
    /**
     * {@snippet lang=c :

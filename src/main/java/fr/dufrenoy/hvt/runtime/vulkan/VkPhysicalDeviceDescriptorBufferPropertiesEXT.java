...
public class VkPhysicalDeviceDescriptorBufferPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        vulkan_h.C_LONG_LONG.withName("bufferCaptureReplayDescriptorDataSize"),
        vulkan_h.C_LONG_LONG.withName("imageCaptureReplayDescriptorDataSize"),
        vulkan_h.C_LONG_LONG.withName("imageViewCaptureReplayDescriptorDataSize"),
        vulkan_h.C_LONG_LONG.withName("samplerCaptureReplayDescriptorDataSize"),
        vulkan_h.C_LONG_LONG.withName("accelerationStructureCaptureReplayDescriptorDataSize"),
        vulkan_h.C_LONG_LONG.withName("samplerDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("combinedImageSamplerDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("sampledImageDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("storageImageDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("uniformTexelBufferDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("robustUniformTexelBufferDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("storageTexelBufferDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("robustStorageTexelBufferDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("uniformBufferDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("robustUniformBufferDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("storageBufferDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("robustStorageBufferDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("inputAttachmentDescriptorSize"),
        vulkan_h.C_LONG_LONG.withName("accelerationStructureDescriptorSize"),
